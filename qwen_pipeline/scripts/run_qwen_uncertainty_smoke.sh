...
rm -rf qwen_pipeline/outputs/uncertainty_smoke
mkdir -p qwen_pipeline/outputs/uncertainty_smoke

python qwen_pipeline/code/05_compute_qwen_uncertainty_smoke.py
