...
rm -rf qwen_pipeline/outputs/masking_generation_smoke
mkdir -p qwen_pipeline/outputs/masking_generation_smoke

python \
  qwen_pipeline/code/10_qwen_masking_generation_smoke.py
