...
OUTDIR="outputs/eval_original_all"
...
../../.venv_epistemic/bin/python eval_scripts/eval_caption.py \
  ...
  --output_dir ../../outputs/eval_original_all \
  --num_samples 522 \
  --max_new_tokens 64 \
  --use_ours \
...
find outputs/eval_original_all -maxdepth 3 -type f | sort | head -20
wc -l outputs/eval_original_all/captions.jsonl
find outputs/eval_original_all/region_uncertainty -maxdepth 1 -type f -name "*.json" | wc -l
