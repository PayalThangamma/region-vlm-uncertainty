...
OUTDIR="outputs/eval_removed_none"
...
../../.venv_epistemic/bin/python eval_scripts/eval_caption.py \
  ...
  --output_dir ../../outputs/eval_removed_none \
  --num_samples 522 \
  --max_new_tokens 64 \
  --use_ours \
...
find outputs/eval_removed_none -maxdepth 3 -type f | sort | head -20
wc -l outputs/eval_removed_none/captions.jsonl
find outputs/eval_removed_none/region_uncertainty -maxdepth 1 -type f -name "*.json" | wc -l
